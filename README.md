...
- download the cmdline.pm
- place it alongside your script
- require it directly. like: require './cmdline.pm';

No CPAN installation needed.

Or to run only all the tests:

- perl Makefile.PL && make test  or  perl t/00-basic.t
...
The distribution includes a comprehensive test suite:
    ...
    t/00-basic.t  # 162 tests covering all features and edge cases

Run with:

    prove -v t/00-basic.t
